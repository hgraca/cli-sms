    ...
    public static function fromArray(array $data)
    {
        ...
        foreach ($reflectionParameterList as $reflectionParameter) {
            ...
            if (
                ...
                throw new Exception("Can't instantiate '" . static::class . ' from an array' . " because argument '$parameterName' is missing and it's not optional." . ' Available argument names: ' . implode(', ', \array_keys($data)));
            }
